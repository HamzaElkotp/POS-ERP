...
use App\Http\Controllers\SellPos1Controller;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu'])->group(function () {
// Route::middleware([])->group(function () {
    ...
    Route::get('/all_trans', [HomeController::class, 'all_trans'])->name('all_trans');
    Route::post('/update_trans/{file}', [HomeController::class, 'update_trans'])->name('update_trans');
    Route::post('/getTransSearch', [HomeController::class, 'getTransSearch'])->name('getTransSearch');
    ...
    Route::resource('pos1', SellPos1Controller::class);
