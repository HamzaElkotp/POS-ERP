<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('levels', __('lang_v1.levels')) !!} 
                {!! Form::number('levels', $business->levels, ['min' => '4', 'max' =>'10','class' => 'form-control ', 'required']); !!}
                {{-- {!! Form::number('levels', $business->level, ['min' => '4', 'max' =>'10', 'class' => 'text-center form-control']) !!} --}}
            </div>
        </div>
    </div>
     {{-- code --}}
