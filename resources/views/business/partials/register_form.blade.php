...
<div class="col-md-6">
    <div class="form-group">
        {!! Form::label('business_logo', __('business.upload_logo') . ':', ['class' => 'col-form-label']) !!}
        <div class="custom-file">
            {!! Form::file('business_logo', ['class' => 'custom-file-input', 'accept' => 'image/*', 'id' => 'customFile']) !!}
            <label class="custom-file-label" for="customFile">{{ __('business.choose_file') }}</label>
        </div>
    </div>
</div>
