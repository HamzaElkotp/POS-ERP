                            ...
                            <td style="text-align: left;">
                                ...
                                @if (!empty($expiry_period_type))
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::input('purchases[' . $loop->index . '][sph]', !empty($sph) ? @format_date($sph) : null, [
                                            'class' => 'form-control input-sm  sph',
                                        ]) !!}
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        ...
                                        {!! Form::input('purchases[' . $loop->index . '][cyl]', !empty($cyl) ? @format_date($cyl) : null, [
                                            'class' => 'form-control input-sm expiry_datepicker cyl',
                                        ]) !!}
                                    </div>
                                @else
