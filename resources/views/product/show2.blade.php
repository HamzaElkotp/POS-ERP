...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex">
            <h2>
                بيان أسعار البيع للعدسه من نوع : {{ $len[0]['name'] }}
            </h2>
        ...
        <div class="card-body" dir="ltr">
            <div class="">
                <form method="POST" action="{{ route('products.store_sell_price', $len[0]['id']) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="tbl">
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                @foreach ($len[0]['len_lenses_diams2'] as $key => $len)
