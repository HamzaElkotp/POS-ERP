    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                @endphp
                <div class="clearfix"></div>
                {{-- @if (in_array('lens', $enabled_modules)) --}}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            name="signal_type_id" id="signal_type_id">
                                            @foreach ($signal_types as $id => $signal_type)
                                                <option value="{{ $id }}"
                                                    {{ old('signal_type_id') == $id ? 'selected' : '0' }}>
                                                    {{ $signal_type }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            name="lens_diameter_id" id="lens_diameter_id">
                                            @foreach ($lens_diameters as $id => $lens_diameter)
                                                <option value="{{ $id }}"
                                                    {{ old('lens_diameter_id') == $id ? 'selected' : '0' }}>
                                                    {{ $lens_diameter }}
                                                </option>
                                            @endforeach
                                        </select>
