										...
										<td class="td3">
											<div class="form-group" dir="ltr">
												...
												<input
													...
													type="text" name="add1" id="add" value="{{ old('add', '') }}">
												@if ($errors->has('add'))
										...
										<td class="td3">
											<div class="form-group" dir="ltr">
												...
												<input
													...
													type="text" name="cyl1" id="cyl1" value="{{ old('cyl', '0.00') }}">
												@if ($errors->has('notes'))
										...
										<td class="td3">
											<div class="form-group" dir="ltr">
												...
												<input
													...
													type="text" name="sph1" id="sph1" value="{{ old('sph', '') }}">
												@if ($errors->has('sph'))
										...
										<td class="td3">
											<div class="form-group" dir="ltr">
												...
												<input
													...
													type="text" name="add" id="add" value="{{ old('add', '') }}">
												@if ($errors->has('add'))
													<span class="text-danger">{{ $errors->first('add') }}</span>
												@endif
												<span
										...
										<td class="td3">
											<div class="form-group" dir="ltr">
												...
												<input
													...
													type="text" name="axis" id="axis" value="{{ old('notes', '') }}">
												@if ($errors->has('axis'))
													<span class="text-danger">{{ $errors->first('axis') }}</span>
												@endif
												<span
										...
										<td class="td3">
											<div class="form-group" dir="ltr">
												...
												<input
													...
													type="text" name="cyl" id="cyl" value="{{ old('cyl', '0.00') }}">
												@if ($errors->has('notes'))
													<span class="text-danger">{{ $errors->first('cyl') }}</span>
												@endif
												<span
										...
										<td class="td3">
											<div class="form-group" dir="ltr">
												...
												<input
													...
													type="text" name="sph" id="sph" value="{{ old('sph', '') }}">
												@if ($errors->has('sph'))
													<span class="text-danger">{{ $errors->first('sph') }}</span>
												@endif
												<span
						...
						<tr class="">
							<td>
								<div class="form-group">
									...
									data-url="{{ action([\Modules\Lens\Http\Controllers\LensController::class, 'get_lens'],  [$id ?? '', $sph ?? '', $cyl ?? '']) }}"
									data-url-price="{{ action([\Modules\Lens\Http\Controllers\LensController::class, 'get_lens_price'],  [$id ?? '', $sph ?? '', $cyl ?? '']) }}"
									data-url-purch-price="{{ action([\Modules\Lens\Http\Controllers\LensController::class, 'get_lens_purch_price'],  [$id ?? '', $sph ?? '', $cyl ?? '']) }}"
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp" type="text" id="lens_diam_id_l"
										value="{{ old('lens_diam_id_l', '') }}" name="lens_diam_id_l">
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp" type="text" id="sph_1_l"
										value="{{ old('sph_1_l', '') }}" name="sph_1_l">
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp" type="text" id="cyl_1_l"
										value="{{ old('cyl_1_l', '') }}" name="cyl_1_l">
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp price_l" type="text" id="price_l"
										value="{{ old('price_l', '') }}" name="price_l">
		
								</div>
							</td>
							<td hidden>
								<div class="form-group">
									<label for="">س شراء</label>
									<input readonly class="inpp purch_price_l" type="text" id="purch_price_l"
										value="{{ old('purch_price_l', '') }}" name="purch_price_l">
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp stock_l" type="text" id="stock_l"
										value="{{ old('stock_l', '') }}" name="stock_l">
		
								</div>
							</td>
							<td>
								<div class="form-group">
									<label for="">كميه</label>
									<input class="inpp quant_l" type="text" id="quant_l"
										value="{{ old('quant_l', '1') }}" name="quant_l">
							...
							<td>
								<div class="form-group">
									<label for="">خصم</label>
									<input class="inpp disc_l" type="text" id="disc_l"
										value="{{ old('disc_l', '') }}" name="disc_l">
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp sub_total_l" type="text" id="sub_total_l"
										value="{{ old('sub_total_l', '') }}" name="sub_total_l">
					...
					<table id="lens_r">
						<tr class="">
							<td>
								<div class="form-group">
									...
									<button class="btn btn-primary btn-sm order-prods" id="get_len_r"
										...
										data-url-purch-price="{{ route('get_lens_purch_price', [$id ?? '', $sph ?? '', $cyl ?? '']) }}" --}}
										data-method="get">
										{{-- data-url="{{ route('admin.sales-invoices.get_lens', [$name ?? '']) }}" data-method="get"> --}}
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp" type="text" id="lens_diam_id_r"
										value="{{ old('lens_diam_id_r', '') }}" name="lens_diam_id_r">
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp" type="text" id="sph_1_r"
										value="{{ old('sph_1_r', '') }}" name="sph_1_r">
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp" type="text" id="cyl_1_r"
										value="{{ old('cyl_1_r', '') }}" name="cyl_1_r">
							...
							<td>
								<div class="form-group">
									<label for="">السعر</label>
									<input readonly class="inpp price_r" type="text" id="price_r"
										value="{{ old('price_r', '') }}" name="price_r">
							...
							<td hidden>
								<div class="form-group">
									<label for="">س شراء</label>
									<input readonly class="inpp purch_price_r" type="text" id="purch_price_r"
										value="{{ old('purch_price_r', '') }}" name="purch_price_r">
							...
							<td>
								<div class="form-group">
									<label for="">الرصيد</label>
									<input readonly class="inpp stock_1_r" type="text" id="stock_1_r"
										value="{{ old('stock_1_r', '') }}" name="stock_1_r">
							...
							<td>
								<div class="form-group">
									<label for="">كميه</label>
									<input class="inpp quant_r" type="text" id="quant_r"
										value="{{ old('quant_r', '1') }}" name="quant_r">
							...
							<td>
								<div class="form-group">
									<label for="">خصم</label>
									<input class="inpp disc_r" type="text" id="disc_r"
										value="{{ old('disc_r', '') }}" name="disc_r">
							...
							<td>
								<div class="form-group">
									...
									<input readonly class="inpp sub_total_r" type="text" id="sub_total_r"
										value="{{ old('sub_total_r', '') }}" name="sub_total_r">
					...
					<div class="col-md-10">
						<table>
							<tr class="d-flex">
								...
								<td class="td2">
									<select id="len_id" name="len_id" class="form-control len_id">
										@foreach ($lens as $id => $len)
											<option value="{{ $len->id }}"
												{{ old('len_id') == $id ? 'selected' : '' }}
												data-id="{{ $len->id }}">
												{{ $len->id }}-{{ $len->lens_type }}</option>
										@endforeach
									</select>
								</td>
