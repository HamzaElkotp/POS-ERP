                                        ...
                                        <tr>
                                            ...
                                            <td class="td3">
                                                <div class="form-group" dir="ltr">
                                                    <label
                                                        for="add">{{ trans('cruds.salesInvoice.fields.add') }}</label>
                                                    <input
                                            ...
                                            <td class="td3">
                                                <div class="form-group" dir="ltr">
                                                    <label
                                                        for="cyl">{{ trans('cruds.salesInvoice.fields.cyl') }}</label>
                                                    <input
                                            ...
                                            <td class="td3">
                                                <div class="form-group" dir="ltr">
                                                    <label
                                                        for="sph">{{ trans('cruds.salesInvoice.fields.sph') }}</label>
                                                    <input
                            ...
                            <tr class="">
                                <td>
                                    <div class="form-group">
										...
										data-url-purch-price="{{ route('get_lens_purch_price', [$id ?? '', $sph ?? '', $cyl ?? '']) }}" --}} data-method="get">
                                            {{-- data-url="{{ route('admin.sales-invoices.get_lens', [$name ?? '']) }}" data-method="get"> --}}
