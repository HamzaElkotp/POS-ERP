...
<section class="content no-print">
    <div class="row">
        <div class="col-md-12">
            ...
            <input type="hidden" id="amount_rounding_method"
                value="{{ $pos_settings['amount_rounding_method'] ?? '' }}">
            ...
            @endphp
            {!! Form::open([
                'url' => action([\App\Http\Controllers\SellPos1Controller::class, 'store']),
                'method' => 'post',
                ...
                <div class="@if (empty($pos_settings['hide_product_suggestion'])) col-md-8 @else col-md-10 offset-md-1 @endif">
                    <div class="card mb-12 @if (!isMobile()) mb-100 @endif">
                        <div class="card-body pb-0 d-block">
                            ...
                            <input type="hidden" class="form-control" id="item_addition_method"
