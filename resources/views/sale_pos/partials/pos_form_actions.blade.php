	...
	<div class="row">
		...
		<div class="row"> {{-- Removed Class --}}
			<div class="col-md-8 d-flex">
				...
				<button type="button" class="btn d-none mx-1" id="closeBtnParentNav"><i class="fa-solid fa-chevron-right"></i></button> 
			</div>
...
<script src="{{ asset('assets/backend/js/custom.js?v='.$asset_v) }}"></script>