...
return [
    ...
    'mapping' => 'إعدادات الحسابات',
    'get_acc_trans' => 'عرض القيود',
    'stock_acc_id' => 'حساب المخزون',
    'discount_earned_acc_id' => 'حساب خصم مكتسب',
    'Value_added_tax_on_purchases_acc_id' => 'حساب ضريبه القيمه المضافه علي المشتريات',
    'shipping_expenses_acc_id' => 'حساب مصاريف الشحن',
    'khazine_acc_id' => 'جساب الخزينه',
    // 'khazine_out_acc_id' => '',
    'sales_revenue_acc_id' => 'حساب ايرادات المبيعات',
    'customers_acc_id' => 'حساب العملاء',
    'cost_of_goods_acc_id' => 'حساب تكلفه البضاعه المباعه',
    'discount_permitted_acc_id' => 'جساب خصم مسموح به',
    ...
    'purch_perc_acc_id' => 'نسبه ضريبه المشتريات',
    'expense_acc' => 'حساب المصروفات',
    'current_assets_acc_id' => 'حساب الأصول المتداوله',
    'income_papers_acc_id' => 'حساب أوراق القبض',
    'madinon_acc_id' => 'حساب المدينون',
    'sales_incentive_acc_id' => 'حساب عموله المبيعات',
    'service_income_acc_id' => 'حساب ايرادات الخدات',
    'daenon_acc_id' => 'حساب الدائنون',
    'expense_papers_acc_id' => 'حساب أوراق الدفع',
    'fixed_assets_acc_id' => 'حساب الأصول الثابته',
    'currency' => 'العمله',
    'invoice_items_count' => 'عدد بنود الفاتوره',
    'stock_acc_id' => 'حساب المخزون',
    ...
    'mon' => 'ضبط حسابات الخزن والبنوك',
    'tax' => 'ضبط خيارات ضرائب المبيعات والمشتريات',
    'madine' => 'ضبط خيارات بعض الأرصدة المدينة',
    'daen' => 'ضبط خيارات بعض الأرصدة الدائنة',
    'store' => 'ضبط خيارات المخازن',
