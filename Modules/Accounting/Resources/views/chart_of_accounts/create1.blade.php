<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\Modules\Accounting\Http\Controllers\CoaController::class, 'store']),
            'method' => 'post',
            ...
            <div class="row">
                <div  class="col-md-12">
                    ...
                    <div hidden class="form-group">
                        ...
                        <select  class="form-control" name="parent_account_id" id="parent_account">
                            ...
                            @foreach ($parent_accounts as $parent_account)
                                <option value="{{ $account->id }}" {{-- @if ($account->parent_account_id == $parent_account->id) selected @endif \ --}}>
                                    {{ $account->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div  class="form-group">
                        ...
                        {!! Form::text('level', $account->level + 1, [
                            'class' => 'form-control',
