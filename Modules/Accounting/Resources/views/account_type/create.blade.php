<div class="modal fade" id="create_account_type_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            {!! Form::open([
                'url' => action([\Modules\Accounting\Http\Controllers\AccountTypeController::class, 'store']),
                'method' => 'post',
                ...
                <div class="row" id="code">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('code', null, ['class' => 'form-control', 'placeholder' => __('accounting::lang.code')]) !!}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" style="width: 100%;" name="account_primary_type"
                                ...
                                @foreach ($account_types as $k => $v)
                                    <option value="{{ $k }}">{{ $v['id'] }} - {{ $v['label'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
