        ...
        <div class="col-md-12">
            <div class="box graph-details">
                <div class="box-header with-border text-center">
                    <h2 class="box-title text-cusTheme">@lang( 'accounting::lang.account_payable_ageing_report' )</h2>
                </div>
                <div class="box-body">
                    <table class="table table-stripped table-bordered">
                        <thead>
                            <tr class="th-custheme-fw-500 th">
                                <th class="th-custheme-color">@lang( 'lang_v1.supplier_name')</th>
