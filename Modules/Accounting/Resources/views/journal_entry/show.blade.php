	...
	@component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="col-md-3">
                    {!! Form::label('journal_date', trans('lang_v1.type')) !!}

                    <div class="form-group">
                        <input disabled type="text" value=" {{$journal->type}}">
                ...
                <div class="col-md-3">
                    {!! Form::label('journal_date', trans('lang_v1.type') ) !!}
                    <div class="form-group">
                        <input disabled type="text" value=" {{$journal->type1}}">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::textarea('note', $journal->note, ['class' => 'form-control', 'readonly', 'rows' => 3]); !!}
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td >
                                {!! Form::select('account_id[' . $i . ']', $default_array, $account_id, 
                                            [ 'disabled' => 'disabled','class' => 'form-control accounts-dropdown account_id', 
                                            'placeholder' => __('messages.please_select'), 'style' => 'width: 100%;']); !!}
                            </td>

                            <td>
                                {!! Form::text('debit[' . $i . ']', $debit, ['disabled' => 'disabled','class' => 'form-control input_number debit']); !!}
                            </td>

                            <td>
                                {!! Form::text('credit[' . $i . ']', $credit, ['disabled' => 'disabled','class' => 'form-control input_number credit']); !!}
                            </td>
                        </tr>
                    @endfor
                </tbody>
