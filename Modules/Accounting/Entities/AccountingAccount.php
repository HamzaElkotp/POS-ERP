...
class AccountingAccount extends Model
{
    ...
    public function transac_sum1()
    {
        return $this->hasManyThrough(AccountingAccountsTransaction::class, $this, 'id');
    }
    public function transac_sum()
    {
        return $this->hasManyThrough(AccountingAccountsTransaction::class, AccountingAccount::class, 'id');
    }
