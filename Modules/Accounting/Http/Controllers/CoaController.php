...
class CoaController extends Controller
{
    ...
    public function index()
    {
        ...
        $levels1 = Business::where('id', $business_id)->first();
        $levels = $levels1->pluck('levels');
    ...
    public function create()
    {
        ...
        if (request()->ajax()) {
            ...
            return view('accounting::chart_of_accounts.create1')->with(compact('account_types'));
        }
    }

    public function ledger1($account_id)
    {
        $business_id = request()->session()->get('user.business_id');
        if (
            !(auth()->user()->can('superadmin') ||
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('accounting::chart_of_accounts.edit')->with(
                compact(
                    'account_types',
                    'account',
                    'account_sub_types',
