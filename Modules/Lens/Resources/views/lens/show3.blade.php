...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex">
            <h2>
                بيان أسعار الشراء للعدسه من نوع : {{ $len->lens_type }}
            </h2>
        ...
        <div class="card-body" dir="ltr">
            <div class="">
                <form method="POST" action="{{ route('lens.store_purch_price', $len->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div dir="rtl" class="row ">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="required" for="sph_to_id">{{ trans('lang.len::len.fields.sph_to') }}</label>
                    ...
                    <div class="tbl">
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                @foreach ($len->len_lenses_diams3 as $key => $len)
                                    ...
                                    <td><input name="s600[]" id="s600" type="text" value="{{ old('s600', $len->s600) }}" ></td>  --}}
                                        ...
                                        <td><input name="_s25[]" id="_s25" type="text"
                                                value="{{ old('_s25', $len->_s25) }}"></td>
                                        <td><input name="_s50[]" id="_s50" type="text"
                                                value="{{ old('_s50', $len->_s50) }}"></td>
                                        <td><input name="_s75[]" id="_s75" type="text"
                                                value="{{ old('_s75', $len->_s75) }}"></td>
