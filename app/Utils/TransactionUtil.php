...
class TransactionUtil extends Util
{
                            ...
                            if (!empty($product['modifier_sell_line_id'][$key])) {
                                ...
                                if (!empty($product['modifier_price'][$key])) {
                                    ...
                                    $modifiers_formatted[] = new TransactionSellLine([
                                        ...
                                        'r_d_shp' => $product['r_d_sph'],
                                        'r_d_cyl' => $product['r_d_cyl'],
                                        'r_d_axi' => $product['r_d_axi'],
                                        'r_rd_cyl' => $product['r_rd_cyl'],
                                        'r_rd_axi' => $product['r_rd_axi'],
                                        'l_d_sph' => $product['l_d_sph'],
    ...
    private function len_quant($prod, $sph, $cyl, $quant)
    {
        // ====================================
        $len1 = $prod;
        $sph1 = $sph;
        ...
        foreach ($store1 as $disc) {
            ...
            $store2->update([$cyl => $stck - $quant1]);

        }

    }
    private function len_quant1($prod2, $sph2, $cyl2, $quant2)
    {         // ====================================
        $len1 = $prod2;
        $sph1 = $sph2;
        $cyl1 = $cyl2;
